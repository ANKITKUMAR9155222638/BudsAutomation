...
public class NavigatingToEntityMaster {
    WebDriver driver;
    ...
    // Test method to perform navigation and file upload
    @Test
    public void navigateToEntityMaster() throws IOException, InterruptedException {
        ...
        // Click on a specific element (example: navigating to a menu item)
        driver.findElement(By.xpath("//body[1]/div[1]/div[1]/div[1]/div[1]/div[1]/aside[1]/div[1]/ul[1]/li[4]/a[1]/div[1]")).click();
        Thread.sleep(2000); // Wait for page to load
    }
