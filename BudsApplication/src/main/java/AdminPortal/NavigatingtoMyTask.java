...
public class NavigatingtoMyTask {
    WebDriver driver;
    ...
    // Test method to navigate to My Task and perform file upload
    @Test
    public void navigateToMyTask() throws IOException, InterruptedException {
