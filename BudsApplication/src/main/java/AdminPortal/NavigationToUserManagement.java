...
public class NavigationToUserManagement {
    WebDriver driver;
    ...
    public void testNavigateToCMS() throws IOException, InterruptedException {
        ...
        // Click on User Management role link
        driver.findElement(By.xpath("//a[contains(@href,'/usermanagement/role')]//div[contains(@class,'rounded-lg flex items-center justify-start cursor-pointer')]")).click();
        Thread.sleep(2000); // Wait for user management page to load
