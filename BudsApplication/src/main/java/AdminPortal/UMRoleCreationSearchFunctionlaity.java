...
public class UMRoleCreationSearchFunctionlaity {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
       ...
       Thread.sleep(1000);
        ...
        driver.findElement(By.xpath("//input[@placeholder='Search by Name/Role']")).sendKeys("Testing");
        driver.findElement(By.xpath("//body/div/div/div/div/div/div/div/div/div/button[1]")).click();
