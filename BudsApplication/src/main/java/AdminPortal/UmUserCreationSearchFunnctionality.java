...
public class UmUserCreationSearchFunnctionality {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
       ...
       Thread.sleep(4000);
        ...
        driver.findElement(By.xpath("//input[contains(@placeholder,'Search by Name/Role')]")).sendKeys("Ankit");
        driver.findElement(By.cssSelector("body > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > button:nth-child(3)")).click();
