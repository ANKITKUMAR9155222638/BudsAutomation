...
public class UserManagementUserCreationEditUser {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
       ...
       Thread.sleep(4000);
        ...
        Thread.sleep(4000);
        	driver.findElement(By.xpath("//tbody/tr[6]/td[5]/div[1]/div[1]/div[1]/button[1]/img[1]")).click();
        	 Thread.sleep(2000);
	 driver.findElement(By.xpath("//input[contains(@name,'LastName')]")).clear();
	 Thread.sleep(2000);
	 driver.findElement(By.xpath("//input[contains(@name,'LastName')]")).sendKeys("akay");
