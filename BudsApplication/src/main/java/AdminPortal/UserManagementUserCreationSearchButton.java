...
public class UserManagementUserCreationSearchButton {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
       ...
       Thread.sleep(4000);
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//input[@placeholder='Search by Name/Role']")).sendKeys("Rohan");
        Thread.sleep(3000);
        driver.findElement(By.cssSelector("button[class='w-40 h-[45px] border-[2px] rounded-[8px] py-[10.5px] px-2 xl:px-[16px] flex justify-center items-center bg-[#1C468E] cursor-pointer border-[#1C468E] mt-2']")).click();
